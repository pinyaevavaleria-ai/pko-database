...
export const bonds: Bond[] = [
  { company: 'ПКБ',              rating: 'ruA- / A.ru', isin: 'RU000A108CC9', coupon: '14.1%',   volume: 1668, platform: 'Мосбиржа', status: 'active', repayment: '23.04.2027' },
  { company: 'ПКБ',              rating: 'ruA- / A.ru', isin: 'RU000A10BGW7', coupon: 'КС+4%',   volume: 2000, platform: 'Мосбиржа', status: 'active', repayment: '06.10.2028' },
  ...
  { company: 'АСВ',              rating: 'BB+(ru)',     isin: 'RU000A106RB3', coupon: '28.4%',   volume:  200, platform: 'Мосбиржа', status: 'active', repayment: '14.08.2026' },
  { company: 'АСВ',              rating: 'BB+(ru)',     isin: 'RU000A10DLC5', coupon: '25.0%',   volume:  200, platform: 'Мосбиржа', status: 'active', repayment: '10.11.2028' },
  { company: 'Финэква',          rating: '—',           isin: 'RU000A10DLN2', coupon: '24%',     volume:  600, platform: 'Мосбиржа', status: 'active', repayment: '06.11.2029' },
  { company: 'СЗА',              rating: 'BB-',         isin: 'RU000A10AA77', coupon: '31%',     volume:  100, platform: 'Мосбиржа', status: 'active', repayment: '25.11.2027' },
  ...
  { company: 'ЮСВ',              rating: 'BBB-',        isin: 'RU000A10CN62', coupon: 'ВДО',     volume: null, platform: 'Мосбиржа', status: 'active', repayment: '20.08.2028' },
];
...
export const corporates: Corporate[] = [
  ...
  { company: 'НФИ',                       founder: 'ГК Регион / МКБ',                     structureType: 'Секьюритизация',        details: 'MBS — ипотечные ценные бумаги' },
  { company: 'Право онлайн',              founder: 'ЗПИФ «Клауд Финанс» (УК «Гамма Групп»)', structureType: 'ЗПИФ',              details: 'Финансирование через ЗПИФ' },
  { company: 'РСВ',                       founder: 'Свеа Экономи Сайпрус (Svea, Швеция)', structureType: 'Иностранная компания',  details: 'Учредитель — иностранная компания' },
  { company: 'АБК',                       founder: 'Сбербанк',                            structureType: 'Банк',                  details: 'Учредитель — банк' },
...
export const allInvestments: AllInvestment[] = [
  ...
  { company: 'АСВ',           type: 'bonds',     details: 'BB+(ru)',      subDetails: '28.4% / 25.0% · 2 выпуска · 400 млн ₽' },
  { company: 'Финэква',       type: 'bonds',     details: '—',           subDetails: '24% · 1 выпуск · 600 млн ₽' },
  { company: 'СЗА',           type: 'bonds',     details: 'BB-',         subDetails: '31% · 1 выпуск · 100 млн ₽' },
  ...
  { company: 'ЮСВ',          type: 'bonds',     details: 'BBB-',        subDetails: 'ВДО · объём н/д' },
  // Займы
  ...
  { company: 'НФИ',           type: 'corporate', details: 'Секьюритизация',        subDetails: 'ГК Регион / МКБ' },
  { company: 'Право онлайн',  type: 'corporate', details: 'ЗПИФ',                  subDetails: 'ЗПИФ «Клауд Финанс»' },
  { company: 'РСВ',           type: 'corporate', details: 'Иностранная компания',  subDetails: 'Свеа Экономи Сайпрус (Svea, Швеция)' },
  { company: 'АБК',           type: 'corporate', details: 'Банк',                  subDetails: 'Сбербанк' },
  ...
  { company: 'Столичная СК',  type: 'corporate', details: 'Иностранная компания',  subDetails: 'Свеа Экономи + РСВ' },
